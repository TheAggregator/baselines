...
def resnet_cnn(unscaled_images):
    ...
    r1_2 = activ(conv(r1_1, 'r1_2', nf=32, rf=3, stride=1, init_scale=np.sqrt(2), pad='SAME'))
    ...
    r2_2 = activ(conv(r2_1, 'r2_2', nf=64, rf=3, stride=1, init_scale=np.sqrt(2), pad='SAME'))
